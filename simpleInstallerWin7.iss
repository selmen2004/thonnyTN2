...
Name: "Python_3112_x86"; Description: "Python 3.11.2 \n\r Ne décocher cette case que si vous vouler utiliser une autre version de python"; Types: full compact custom;
...
Name: "bac_eco"; Description: "Bibliothèques pour bac économie:  pandas matplotlib xlrd xlsxwriter xlwt openpyxl jupyterlab notebook"; Types: full compact custom;
...
Name: "LabDesktopIcon"; Description: "Créer icone bureau pour Jupyter Lab"   ; Components: "bac_eco"
Name: "NotebookDesktopIcon"; Description: "Créer icone bureau pour Jupyter Notebook Clasique"   ; Components: "bac_eco"
[Icons]
...
Filename:"{tmp}\python-3.11.2-full-win7compatible.exe" ;Parameters:  "PrependPath=1 SimpleInstall=1 "  ; Description: "Installation de Windows7 SP1(s'il n'est pas installé) , il peut être nécéssaire de redémarrer "; Components:    "Python_3112_x86"
...
const
  ...
  RunOnceName = 'Redémarrage de l'' installation';
