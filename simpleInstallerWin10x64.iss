...
Filename:"cmd.exe" ;Parameters: "/q /c mode 80,5 && title Installation de Thonny ... && {tmp}\RefreshEnv.cmd &&  py.exe -m pip install thonny esptool --no-index --find-links {tmp}\deps --prefer-binary  >> {tmp}\innosetup.log" ;StatusMsg:"Installation de Thonny ... "; Components: "editors"
Filename:"cmd.exe" ;Parameters: "/q /c mode 80,5 && title Installation de Bibliothèques Bac Scientifiques ... && {tmp}\RefreshEnv.cmd &&  py.exe -m pip install pyqt5 numpy --no-index --find-links {tmp}\deps --prefer-binary >> {tmp}\innosetup.log" ;StatusMsg:"Installation de Bibliothèques Bac Scientifiques ... "; Components: "bac_sc"
Filename:"cmd.exe" ;Parameters: "/q /c mode 80,5 && title Installation de Qt5 Designer ... && {tmp}\RefreshEnv.cmd &&  py.exe -m pip install pyqt5_qt5_designer --no-index --find-links {tmp}\deps --prefer-binary >> {tmp}\innosetup.log" ;StatusMsg:"Installation de Designer ... "; Components: "bac_sc"
...
Filename:"cmd.exe" ;Parameters: "/q /c mode 80,5 && title Installation de Jupyter Lab  ... &&{tmp}\RefreshEnv.cmd &&  py.exe -m pip install pandas matplotlib xlrd xlsxwriter xlwt openpyxl jupyterlab notebook --no-index --prefer-binary --find-links {tmp}\deps >> {tmp}\innosetup.log" ;StatusMsg:"Installation de Jupyter Lab  ... "; Components: "bac_eco\jupyter_lab"
Filename:"cmd.exe" ;Parameters: "/q /c mode 80,5 && title Installation de Jupyter Notebook Classique... &&{tmp}\RefreshEnv.cmd &&  py.exe -m pip install notebook --no-index --prefer-binary --find-links {tmp}\deps >> {tmp}\innosetup.log" ;StatusMsg:"Installation de Jupyter Notebook Classique  ... "; Components: "bac_eco\jupyter_notebook"
Filename:"cmd.exe" ;Parameters: "/q /c mode 80,5 && title القدس لنا وكل فلسطين  &&{tmp}\RefreshEnv.cmd &&  py.exe -m pip install thonny_palestine_flag --no-index --prefer-binary --find-links {tmp}\deps >> {tmp}\innosetup.log" ;StatusMsg:"Installation de Palestine Flag pour Thonny  ... "; Components: "editors\ps_flag_thonny"
Filename:"cmd.exe" ;Parameters: "/q /c mode 80,5 && title Installation de Thonny Autosave... &&{tmp}\RefreshEnv.cmd &&  py.exe -m pip install thonny-autosave --no-index --prefer-binary --find-links {tmp}\deps >> {tmp}\innosetup.log" ;StatusMsg:"Installation de Thonny Autosave  ... "; Components: "editors\thonny_autosave"
