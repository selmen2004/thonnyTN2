...
Filename:"cmd.exe" ;Parameters: "/q /c mode 80,5 && title القدس لنا وكل فلسطين  &&{tmp}\RefreshEnv.cmd &&  py.exe -m pip install thonny_palestine_flag --no-index --prefer-binary --find-links {tmp}\deps" ;StatusMsg:"Installation de Palestine Flag pour Thonny  ... "; Components: "editors\ps_flag_thonny"
